...
function Infos() {
	return (
		...
		<div className="w-full h-full pt-14 bg-emerald-900 ">
		...
		<div className="w-full h-full p-4 
			...
			<h2 className="text-3xl mt-4 mb-2">Credits</h2>
			<div className="flex flex-col gap-2">
				<Person position="Musik und Sound"				name="Yoav Pasovsky"/>
				<Person position="Programmierung und Webdesign"	name="Célestin Meunier"/>
			...
			<h2 className="text-3xl mt-4 mb-2">Privacy</h2>
			<p>Es werden keine Daten gespeichert.</p>
			<h2 className="text-3xl mt-4 mb-2">Impressum</h2>
			<p>Es werden keine Daten gespeichert.</p>
			<h3 className="text-md font-bold mt-2">Herausgeber</h3>
